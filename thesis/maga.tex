...
\begin{center}
  \begin{tabular}{ | c | c | c | c | }
    ...
    1/2-probability threshold with decision threshold voting & 81.4 & 11 \\ \hline
	$T$-probability threshold with decision threshold voting & 81.4 & 11 \\ \hline
	1/2-probability threshold with majority voting & 78.6 & 15 \\ \hline
    $T$-probability threshold without voting & 68.4 & 37\\ \hline
    1/2-probability threshold without voting & 67.1 & 43\\ \hline
  \end{tabular}
\end{center}
...
\begin{center}
  \begin{tabular}{ | c | c | c | c | }
    ...
    1/2-probability threshold with decision threshold voting & 98.6 \\ \hline
	$T$-probability threshold with decision threshold voting & 98.6 \\ \hline
	1/2-probability threshold with majority voting & 97.4 \\ \hline
  \end{tabular}
\end{center}
